...
def convertFastaToNexus(inputFile, outputDir, CDS, mrBayesNST = 6, mrBayesRates = "invgamma", mrBayesNgen = 10000000, mrBayesBurninFrac = 0.25, mrBayesSampleFreq = 1000, mrBayesNsteps = 30, threads = 1 ):
...
def concatenateAlignments(aln1, aln2, outputDir, CDS, mrBayesNST = 6, mrBayesRates = "invgamma", mrBayesNgen = 10000000, mrBayesBurninFrac = 0.25, mrBayesSampleFreq = 1000, mrBayesNsteps = 30, threads = 1 ):
	...
	if CDS == False:
		...
		outfile.write("charset first  = 1-%d\\3;" % masterDict[aln1]['nchar'])
		outfile.write("charset second = 2-%d\\3;" % masterDict[aln1]['nchar'])
		outfile.write("charset third  = 3-%d\\3;" % masterDict[aln1]['nchar'])
		outfile.write("charset fourth  = %d-%d\\3;" %(masterDict[aln1]['nchar']+1, masterDict[aln2]['nchar']))
		outfile.write("charset fifth = %d-%d\\3;" %(masterDict[aln1]['nchar']+1, masterDict[aln2]['nchar']))
		outfile.write("charset sixth  = %d-%d\\3;" %(masterDict[aln1]['nchar']+1, masterDict[aln2]['nchar']))
